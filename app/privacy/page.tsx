...
export default function PrivacyPolicy() {
  return (
    /* `body` is `overflow: hidden` so the hymnal shell can be pinned to the
       viewport, which left this page silently cut off at the fold with no way
       to reach the rest of it. Everything scrollable in this app lives in a
       nested container; this page had simply never been given one. */
    <main className="h-full overflow-y-auto">
      <div className="mx-auto max-w-[38rem] px-6 py-12">
        ...
        <div className="space-y-8 font-sans text-sm leading-relaxed text-paper-muted">
          <section>
            <p>
              ...
              in Modesto, California. It is free, carries no advertising, and sells nothing. There
              are no accounts and no sign-in.
            </p>
            <p className="mt-3">
              Most of what the app does happens entirely on your device. The sections below cover
              the parts that don&rsquo;t.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              stored in your browser and are not sent anywhere &mdash; unless you deliberately
              create a sync code, described below. Clearing your browser data removes them.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p className="mt-3">
              A sync code holds hymn numbers, tune names and display settings. It carries no name,
              no email address, and no device identifier. Nothing in it says who you are. It is
              created only when you press the button.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              sets no cookies and does not follow you to other websites. It is run by the same
              person who maintains this app, not sold or shared with an advertising company.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="ml-5 list-disc space-y-1.5">
              <li>
                <strong className="text-paper-ink">Vercel</strong> hosts the app. Like any web host
                it records ordinary server logs, which include IP addresses.
              </li>
              <li>
                <strong className="text-paper-ink">Neon</strong> is the database holding sync codes
          ...
          <section>
            ...
            <p>
              Ask, and any suggestion you sent will be deleted. Sync codes delete themselves within
              a day; to remove one sooner, ask. Everything held on your own device you can clear
